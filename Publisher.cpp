...
int ACE_TMAIN(int argc, ACE_TCHAR *argv[]){
  try {
    ...
    HelloModule::HelloTypeSupport_var ts =
      new HelloModule::HelloTypeSupportImpl;
    ...
    HelloModule::HelloDataWriter_var hello_writer =
      HelloModule::HelloDataWriter::_narrow(writer);
    ...
    if (hello_writer->wait_for_acknowledgments(timeout) != DDS::RETCODE_OK) {
      ACE_ERROR_RETURN((LM_ERROR,
                        ACE_TEXT("ERROR: %N:%l: main() -")
